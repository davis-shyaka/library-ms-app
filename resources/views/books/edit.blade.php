                ...
                <div class="p-6 bg-gray-500 dark:bg-[#020917] border-b border-cyan-400">
                    ...
                    <form method="POST" action="{{ route('books.update', $book) }}">
                        ...
                        <div class="relative space-y-4">
                            <div>
                                <label class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">New
                                    Title</label>
                                <input name="title" value="{{ $book->title }}" type="text" id=""
                                    class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-black bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                            ...
                            <div>
                                ...
                                <input name="isbn" type="text" id="floating_filled" value={{ $book->isbn }}
                                    class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " />
                            </div>
                            ...
                            <button
                                class="inline-flex items-center px-4 py-2 bg-yellow-400 border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-white hover:text-yellow-400 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150"
